    ...
    <section class="cz-carousel cz-controls-lg mb-4 mb-lg-5">
      <div class="cz-carousel-inner" data-carousel-options="{&quot;autoplay&quot;:&quot;false&quot;,&quot;mode&quot;: &quot;gallery&quot;, &quot;responsive&quot;: {&quot;0&quot;:{&quot;nav&quot;:true, &quot;controls&quot;: false},&quot;992&quot;:{&quot;nav&quot;:false, &quot;controls&quot;: true}}}">
        <!-- Item-->
        <div class="px-lg-5" style="background-color: rgb(255, 199, 80);">
          <div class="d-lg-flex justify-content-between align-items-center pl-lg-4"><img class="d-block order-lg-2 mr-lg-n5 flex-shrink-0" src="client/img/home/hero-slider/vetement.png" alt="Men Accessories">
            <div class="position-relative mx-auto mr-lg-n5 py-5 px-4 mb-lg-5 order-lg-1" style="max-width: 42rem; z-index: 10;">
              <div class="pb-lg-5 mb-lg-5 text-center text-lg-left text-lg-nowrap">
                <h2 class="text-light font-weight-light pb-1 from-top">Habillez vous en pagne</h2>
                <h1 class="text-light display-4 from-top delay-1">Vêtements en pagne</h1>
                <p class="font-size-lg text-light pb-3 from-top delay-2">Des vêtements pour tous au modèle particulier</p>

                <a class="btn btn-primary scale-up btn-shadow delay-4 catgInd"
                   id="16"
                   catg="vêtement"
                   href="#"
                   style="border-color: black; background-color: #373f50">
        ...
        <!-- Item-->
        <div class="px-lg-5" style="background-color: rgb(222, 185, 199); " >
          <div class="d-lg-flex justify-content-between align-items-center pl-lg-4"><img class="d-block order-lg-2 mr-lg-n5 flex-shrink-0" src="client/img/home/hero-slider/accessoires.png" alt="Men Accessories">
            <div class="position-relative mx-auto mr-lg-n5 py-5 px-4 mb-lg-5 order-lg-1" style="max-width: 42rem; z-index: 10;">
              <div class="pb-lg-5 mb-lg-5 text-center text-lg-left text-lg-nowrap">
                <h2 class="text-light font-weight-light pb-1 from-top">Relooking de vos accessoires</h2>
                <h1 class="text-light display-4 from-top delay-1">Sacs Chics et Stylés</h1>
                <p class="font-size-lg text-light pb-3 from-top delay-2">Revivez le style de vos accessoires autrement</p>
        ...
        <!-- Item-->
        <div class="px-lg-5" style="background-image: url('client/img/home/hero-slider/12.png');">
          <div class="d-lg-flex justify-content-between align-items-center pl-lg-4"><img class="d-block order-lg-2 mr-lg-n5 flex-shrink-0" src="client/img/home/hero-slider/chaussure.png" alt="Men Accessories">
            <div class="position-relative mx-auto mr-lg-n5 py-5 px-4 mb-lg-5 order-lg-1" style="max-width: 42rem; z-index: 10;">
              <div class="pb-lg-5 mb-lg-5 text-center text-lg-left text-lg-nowrap">
                <h2 class="text-light font-weight-light pb-1 from-top">Une concentration d’authenticité</h2>
                <h1 class="text-light display-4 from-top delay-1">Chaussures personnalisées</h1>
                <p class="font-size-lg text-light pb-3 from-top delay-2">Chaussure pour femmes, hommes &amp; enfants...</p>
                 <a class="btn btn-primary scale-up delay-4 catgInd"
                   href="#"
                    id="14"
                    catg="Accessoires">
             ...
             <div>
                <div class="row mx-n2">
                  @php
                    $nb = 0;
                  @endphp
                 @foreach(getPudProdCatg('vêtement') as $prd)
                   @php $nb = $nb+1; @endphp
                   @if($nb<7)
                   <!-- Product-->
              ...
              <div>
                <div class="row mx-n2">
                  @php
                    $nb = 0;
                  @endphp
                  @foreach(getPudProdCatg('chaussure') as $prd)
              ...
              <div>
               <div class="row mx-n2">
                  @php
                    $nb = 0;
                  @endphp
                  @foreach(getPudProdCatg('accessoire') as $prd)
