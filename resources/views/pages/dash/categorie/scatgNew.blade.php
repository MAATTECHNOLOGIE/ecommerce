<div class="card mb-3">
  ...
  <div class="card-body">
    <div class="row">
      <div class="col-lg-8">
        <h3 class="mb-0">Nouvelle Sous catégorie de produit</h3>
        <p class="mt-2">Définissez les différentes sous-catégories de vos produits</p>
      </div>
    </div>
  </div>
      ...
      <div class="col-12">
       <form>
        ...
        <div class="form-group">
          <label for="name">Sous-Catégorie</label>
